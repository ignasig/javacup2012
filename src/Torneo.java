...
public class Torneo {
    ...
    /**Ejecuta un partido de torneo, se indica la instancia (cuartos, semi, clasificatorias, etc),
     * La fecha de ejecucion y las tacticas
     * @param instancia
     * @param fecha
     * @param local
     * @param visita
    ...
    public Torneo(String instancia, int fecha, Tactic local, Tactic visita) throws Exception {
        ...
        frame.dispose();
        //System.out.println("##### " + partido.getGolesLocal() + "-" + partido.getGolesVisita() + " " + partido.getPosecionBalonLocal() + "-" + (1 - partido.getPosecionBalonLocal()));
    }
    ...
    public int getGanador() {
        if (partido.getGolesLocal() > partido.getGolesVisita()) {
            ...
            if (partido.getPosecionBalonLocal() >= .5) {
                return 0;
            }
        }
        return 1;
     ...
     * 'n' como la cantidad de equipos.
     * Retorna un array donde:
     * el primer indice representa la fecha
     * el segundo representa el partido de la fecha
     * y el tercer indice 0: equipo local y 1: la visita
     *
    ...
    private static Class[] tactics = new Class[]{
        org.javahispano.javacup.tacticas.tacticas_aceptadas.masia.Masia.class,//26 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Tactica1A.Tactica1A.class,//25 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.arturo8a.TacticaPulgarcitos.class,//25 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Mou_team.Mou_Team.class,//24 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.absolutsport.tactica.TacticaAbsolutSport.class,//23 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.ChelseaMillos2.ChelseaMillos2.class,//21 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.CTeam.tactica.CTeam2011.class,//20 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.SlapstickFC.SlapstickFC.class,//20 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.tacticaMonsters.Monsters.class,//18 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.MSGTactica.class,//17 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.LivingLabTeam.LivingLabTeam.class,//17 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.rabobong.Rabobong.class,//16 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Arsenal3.Arsenal3.class,//14 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.TacticaMagallanes.TacticaMagallanes.class,//14 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Sag.Sag.class,//13 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.diversion.TacticaDiversion.class,//13 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Rajaos.Rajaos11.class,//11 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.robertiano.Loberos.class,//11 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.meerkats.Estrategia.class,//10 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Patones.Patones.class,//9 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Orange.Orange.class,//8 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.ifox.javacup.tactica.Leti.class,//7 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.elepanderevo.ElepanderEvo.class,//5 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.emandem.EmAndEmTactica.class,//5 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.jmv.KapriFC.class,//3 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.marranos.marranos.class,//2 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.pringaos2011.Pringaos2011.class,//1 puntos.
        org.javahispano.javacup.tacticas.tacticas_aceptadas.Chupones.Chupones.class//0 puntos.
    };

    //array de grupos de la primera fase
    private static Class[][] gruposPublicados() {
        return new Class[][]{
                    {org.javahispano.javacup.tacticas.tacticas_aceptadas.Arsenal3.Arsenal3.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.ifox.javacup.tactica.Leti.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.robertiano.Loberos.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.marranos.marranos.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.CTeam.tactica.CTeam2011.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.tacticaMonsters.Monsters.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.arturo8a.TacticaPulgarcitos.class,},
                    {org.javahispano.javacup.tacticas.tacticas_aceptadas.jmv.KapriFC.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.emandem.EmAndEmTactica.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.Tactica1A.Tactica1A.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.rabobong.Rabobong.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.Rajaos.Rajaos11.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.Sag.Sag.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.absolutsport.tactica.TacticaAbsolutSport.class,},
                    {org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.MSGTactica.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.Chupones.Chupones.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.Mou_team.Mou_Team.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.diversion.TacticaDiversion.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.elepanderevo.ElepanderEvo.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.Patones.Patones.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.ChelseaMillos2.ChelseaMillos2.class,},
                    {org.javahispano.javacup.tacticas.tacticas_aceptadas.LivingLabTeam.LivingLabTeam.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.Orange.Orange.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.meerkats.Estrategia.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.pringaos2011.Pringaos2011.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.SlapstickFC.SlapstickFC.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.masia.Masia.class,
                        org.javahispano.javacup.tacticas.tacticas_aceptadas.TacticaMagallanes.TacticaMagallanes.class,},};
    }
    ...
    static void eliminatorias(String path) {
        ...
        int[][] cruce = new int[][]{{0, 7}, {9, 14}, {6, 1}, {15, 8}, {2, 5}, {11, 12}, {4, 3}, {13, 10}};
        for (int i = 0; i < cruce.length; i++) {
            ...
            System.out.println(" 8° -> " + nl + " " + p.getGolesLocal() + " - " + nv + " " + p.getGolesVisita() + "     " + p.getPosecionBalonLocal() + "-" + (1 - p.getPosecionBalonLocal()));
        ...
        for (int i = 0; i < cruce.length; i++) {
            ...
            System.out.println(" 4° -> " + nl + " " + p.getGolesLocal() + " - " + nv + " " + p.getGolesVisita() + "     " + p.getPosecionBalonLocal() + "-" + (1 - p.getPosecionBalonLocal()));
        ...
        for (int i = 0; i < cruce.length; i++) {
            ...
            System.out.println("SF -> " + nl + " " + p.getGolesLocal() + " - " + nv + " " + p.getGolesVisita() + "     " + p.getPosecionBalonLocal() + "-" + (1 - p.getPosecionBalonLocal()));
            pasan2.add(pt.getGanador() == 0 ? tl.getClass() : tv.getClass());
        ...
        for (int i = 0; i < cruce.length; i++) {
            ...
            if (i == 0) {
                System.out.println("34 -> " + nl + " " + p.getGolesLocal() + " - " + nv + " " + p.getGolesVisita() + "     " + p.getPosecionBalonLocal() + "-" + (1 - p.getPosecionBalonLocal()));
            }
            if (i == 1) {
                System.out.println("12 -> " + nl + " " + p.getGolesLocal() + " - " + nv + " " + p.getGolesVisita() + "     " + p.getPosecionBalonLocal() + "-" + (1 - p.getPosecionBalonLocal()));
            }
            try {
                p.getPartidoGuardado().save(new File(filename));
            } catch (Exception e) {
        ...
        for (int k = 0; k < grupos.length; k++) {
            ...
            for (int i = 0; i < partidos.length; i++) {
                ...
                for (int j = 0; j < partidos[i].length; j++) {
                    ...
                    System.out.println("\t\t\tRESULTADO: " + p.getGolesLocal() + "-" + p.getGolesVisita() + "\t" + p.getPosecionBalonLocal() + "-" + (1 - p.getPosecionBalonLocal()));
    ...
    public static void main(String[] args) {
        ...
        liguilla();
        //printGrupos(gruposFase1(7, 7, 7, 7));
        //primeraFase("c:\\jvc2011");
        //eliminatorias("c:\\jvc2011\\eliminatorias");
    }
}
