...
import org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.MSGPuntoTrayectoria;
import org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.MSGTrayectoria;
import org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.MSGUtils;
...
public class JugadoresBalonThread<I> implements IdentificableCallable<I, JugadoresBalonData> {
    ...
    public JugadoresBalonData call() throws Exception {
        ...
        for (int i = 0; i <= trayectoria.getIteracionMax(); i++) {
            ...
            if (x != null || y != null) {
                Punto3D puntoFueraCampo = new Punto3D(x == null ? punto.getPunto().getX() : x, y == null ? punto.getPunto().getY() : y, 0);
