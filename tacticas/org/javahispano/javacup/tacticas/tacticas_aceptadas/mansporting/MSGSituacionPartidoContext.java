...
import org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.thread.IdentificableData;
...
import org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.thread.JugadoresBalonThread;
import org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.thread.PaseData;
import org.javahispano.javacup.tacticas.tacticas_aceptadas.mansporting.thread.PaseThread;
...
public class MSGSituacionPartidoContext {
    ...
    private void updateJugadoresCercanosBalon() {
        ...
        try {
            ...
            JugadoresBalonThread thread = new JugadoresBalonThread(null, jugadores, MSGTrayectoria.getInstance(situacionPartido));
