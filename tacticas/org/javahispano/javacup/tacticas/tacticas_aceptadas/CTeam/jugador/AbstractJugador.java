...
import static org.javahispano.javacup.model.util.Constants.AMPLIFICA_VEL_TRAYECTORIA;
import static org.javahispano.javacup.model.util.Constants.DISTANCIA_CONTROL_BALON;
...
public abstract class AbstractJugador implements IJugadorCT {
	...
	/**
	 * determina si este jugador puede realizar un pase a la posicion de destino<br>
	 * <br>
	 * retorna null si el pase no es posible, o el Disparo con el cual se debe
	 * realizar el pase
	 */
	@Override
	public Disparo paseLibre(PosicionCT des, int itRematar) {
		...
		AbstractTrajectory trayectoria = new AirTrajectory(Math.cos(angVer) * vel, Math.sin(angVer) * vel,
				0, 0);
	...
	/**
	 * retornal la distancia que puede recorred el jugador en el numero de
